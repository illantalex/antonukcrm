...
urlpatterns += [
    path('manager_page/<int:pk>',
         views.ManagerCabinet.as_view(), name='manager_page'),
...
urlpatterns += [
    ...
    path('message/<int:pk>/update/',
         views.MessageUpdate.as_view(), name='message_update'),
    path('message/<int:pk>/delete/',
         views.MessageDelete.as_view(), name='message_delete'),
]
